...
class AppAsset extends AssetBundle
{
    ...
    public $js = [
        'https://use.fontawesome.com/b17cc3a995.js','js/geral.js','js/utils.js','js/buscaCNPJ.js','js/gastronomia.js','js/lojas.js','js/subcategoria.js','js/filmes.js','js/genero.js','js/distribuidora.js','js/diretor.js',
